...
<main class="content">
    <div class="container-fluid p-0">
        ...
        <div class="card border-0 shadow-sm">
            <div class="card-body">
                <form action="/servers/store" method="post" class="needs-validation" novalidate>
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="hostname" name="hostname" 
                                       value="<?= htmlspecialchars($_SESSION['old']['hostname'] ?? '') ?>" 
                                       required>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="port" name="port" 
                                       value="<?= htmlspecialchars($_SESSION['old']['port'] ?? 9090) ?>" 
                                       min="1" max="65535">
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" rows="2"><?= htmlspecialchars($_SESSION['old']['description'] ?? '') ?></textarea>
                            ...
                            <div class="mb-3">
                                <label for="password" class="form-label">Cockpit Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control" id="password" name="password" required>
                                <div class="form-text">Password will be encrypted in the database.</div>
                            </div>
                            
                            <div class="mb-3">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="use_ssl" name="use_ssl"
                                           <?= isset($_SESSION['old']['use_ssl']) && $_SESSION['old']['use_ssl'] ? 'checked' : '' ?>>
